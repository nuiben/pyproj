...
import json, locale, sys, reports, emails
...
def process_data(data):
  ...
  for item in data:
    ...
    popular_car_year[item["car"]["car_year"]] = popular_car_year.get(item["car"]["car_year"], 0) +  item["total_sales"]

  popular_car_sorted = sorted(popular_car_year.items(), key=lambda a: a[1], reverse=True)

  summary = [
    "The {} generated the most revenue: ${}".format(
      format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(max_sales['car_model'], max_sales['total_sales']),
    "The most popular year was {} with {} sales.".format(popular_car_sorted[0][0], popular_car_sorted[0][1]),
  ]
...
def cars_dict_to_table(car_data):
  ...
  table_columns = [["ID", "Car", "Price", "Total Sales"]]
  cars_list = []
  ...
  return table_columns + cars_list
